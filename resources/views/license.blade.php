                            ...
                            <div class="card mb-3">
                                ...
                                <form action="{{ route('updatePhoto') }}" method="POST" enctype="multipart/form-data">
                                    <div class="card-body text-center shadow">
                                        <img class="rounded-circle mb-3 mt-4" src="{{ asset($photo ? 'storage/' . $photo : 'assets/img/dogs/Screenshot%202024-02-15%20140714.png') }}" width="160" height="160">
                                        <div class="mb-3">
