...
<head>
    ...
    <title>Datenschutzerklärung - ConsentFlow</title>
                                ...
                                <div class="col">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h4 class="text-dark mb-4">Datenschutzerklärung</h4>
                                        </div>
                                        <p>Moritz Pukrop<br>Vertretungsberechtigte(r): c/o Block Services<br>Stuttgarter Str. 106<br>70736 Fellbach<br>Deutschland<br>Keine Pakete oder Päckchen - Annahme wird verweigert!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
